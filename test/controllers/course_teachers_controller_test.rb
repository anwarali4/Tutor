...
class CourseTeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_teacher" do
    assert_difference("CourseTeacher.count") do
      post course_teachers_url, params: { course_teacher: { course_id: @course_teacher.course_id, teacher_id: @course_teacher.teacher_id } }
    end
  ...
  test "should update course_teacher" do
    patch course_teacher_url(@course_teacher), params: { course_teacher: { course_id: @course_teacher.course_id, teacher_id: @course_teacher.teacher_id } }
